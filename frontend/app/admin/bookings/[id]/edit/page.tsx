    ...
    <main className="relative min-h-screen overflow-hidden bg-[#060914] px-5 py-8 text-white sm:px-8 lg:py-10">
      ...
      <section className="relative mx-auto max-w-4xl">
        ...
        <div className="mt-6 rounded-[2.25rem] border border-white/10 bg-white/[0.04] p-6 shadow-2xl shadow-black/40 backdrop-blur sm:p-8">
          ...
          <h1 className="mt-3 text-4xl font-black tracking-tight">Edit booking</h1>
          <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300">
            Update the booking status, traveler information, schedule, and total amount.
          </p>

          <div className="mt-7">
            <BookingForm key={result.data.id} booking={result.data} />
          </div>
        </div>
      </section>
    </main>
